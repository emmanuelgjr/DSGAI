...
function AgentIcon({ x, y, size = 40, color = '#e879f9' }) {
  return (
    <g transform={`translate(${x - size/2}, ${y - size/2})`}>
      <rect x="4" y={size*0.2} width={size-8} height={size*0.65} rx="4" fill="none" stroke={color} strokeWidth="1.5" />
      <line x1={size*0.3} y1={size*0.05} x2={size*0.3} y2={size*0.2} stroke={color} strokeWidth="1.5" />
      <line x1={size*0.7} y1={size*0.05} x2={size*0.7} y2={size*0.2} stroke={color} strokeWidth="1.5" />
      <circle cx={size*0.3} cy={size*0.05} r="2" fill={color} />
      <circle cx={size*0.7} cy={size*0.05} r="2" fill={color} />
      <rect x={size*0.2} y={size*0.38} width={size*0.6} height={size*0.12} rx="2" fill={color} opacity="0.4" />
      <rect x={size*0.2} y={size*0.56} width={size*0.4} height={size*0.12} rx="2" fill={color} opacity="0.4" />
    </g>
  )
}
...
const diagramConfigs = {
  DSGAI01: {
    ...
    edges: [
      { from: 'attacker', to: 'llm', color: '#f87171', animated: true, label: 'Extract', labelPos: 0.3, curveOffset: 50 },
      { from: 'training', to: 'llm', color: '#2dd4bf', animated: true, label: 'Memorized' },
      { from: 'attacker', to: 'vdb', color: '#f87171', animated: true, label: 'Semantic probe', labelPos: 0.7, curveOffset: -50 },
      { from: 'docs', to: 'rag', color: '#fbbf24', animated: true, label: 'Overshared' },
      { from: 'rag', to: 'vdb', color: '#a78bfa', animated: true, label: 'No ACL' },
      { from: 'llm', to: 'output', color: '#f87171', animated: true, label: 'Verbatim leak', labelPos: 0.3, curveOffset: 40 },
      { from: 'vdb', to: 'output', color: '#f87171', animated: true, label: 'Retrieved PII', labelPos: 0.7, curveOffset: -40 },
  ...
  DSGAI03: {
    ...
    edges: [
      { from: 'employee', to: 'chatgpt', color: '#f87171', animated: true, label: 'Pastes PII', labelPos: 0.3, curveOffset: 60 },
      { from: 'corpdata', to: 'employee', color: '#2dd4bf', animated: true, label: 'Copies' },
      { from: 'employee', to: 'saasai', color: '#f87171', animated: true, label: 'Bypasses CASB', labelPos: 0.5, curveOffset: 0 },
      { from: 'employee', to: 'internal', color: '#f87171', animated: true, label: 'No review', labelPos: 0.7, curveOffset: -60 },
  ...
  DSGAI05: {
    ...
    edges: [
      { from: 'attacker', to: 'input', color: '#f87171', animated: true, label: 'Path traversal', labelPos: 0.3, curveOffset: 55 },
      ...
      { from: 'attacker', to: 'snapshot', color: '#f87171', animated: true, label: 'Craft snap', labelPos: 0.5, curveOffset: 0 },
      { from: 'snapshot', to: 'vectordb', color: '#f87171', animated: true, label: 'Restore' },
      { from: 'attacker', to: 'labelq', color: '#f87171', animated: true, label: 'Inject labels', labelPos: 0.7, curveOffset: -55 },
  ...
  DSGAI06: {
    ...
    edges: [
      ...
      { from: 'context', to: 'mcp', color: '#f87171', animated: true, label: 'Full context', labelPos: 0.3, curveOffset: 40 },
      { from: 'context', to: 'plugin', color: '#f87171', animated: true, label: 'No scoping', labelPos: 0.7, curveOffset: -40 },
  ...
  DSGAI07: {
    ...
    edges: [
      ...
      { from: 'pipeline', to: 'embeddings', color: '#a78bfa', animated: true, label: 'No label', labelPos: 0.3, curveOffset: 55 },
      { from: 'pipeline', to: 'weights', color: '#a78bfa', animated: true, label: 'No label', labelPos: 0.5, curveOffset: 0 },
      { from: 'pipeline', to: 'backups', color: '#a78bfa', animated: true, label: 'No label', labelPos: 0.7, curveOffset: -55 },
      ...
      { from: 'weights', to: 'persist', color: '#f87171', animated: true, label: 'Still active', labelPos: 0.3, curveOffset: 40 },
      { from: 'backups', to: 'persist', color: '#f87171', animated: true, label: 'Retained', labelPos: 0.7, curveOffset: -40 },
    ],
  ...
  DSGAI08: {
    ...
    edges: [
      ...
      { from: 'system', to: 'sourcedb', color: '#a78bfa', animated: true, label: 'Deleted OK', labelPos: 0.3, curveOffset: 55 },
      { from: 'system', to: 'weights', color: '#f87171', animated: true, label: 'Can\'t unlearn', labelPos: 0.5, curveOffset: 0 },
      { from: 'system', to: 'vectors', color: '#f87171', animated: true, label: 'Still indexed', labelPos: 0.7, curveOffset: -55 },
      { from: 'weights', to: 'evidence', color: '#f87171', animated: true, label: 'No proof', labelPos: 0.3, curveOffset: 40 },
      { from: 'vectors', to: 'evidence', color: '#f87171', animated: true, label: 'No proof', labelPos: 0.7, curveOffset: -40 },
  ...
  DSGAI09: {
    ...
    edges: [
      { from: 'user', to: 'image', color: '#60a5fa', animated: true, label: 'Upload', labelPos: 0.3, curveOffset: 40 },
      { from: 'user', to: 'audio', color: '#60a5fa', animated: true, label: 'Record', labelPos: 0.7, curveOffset: -40 },
      ...
      { from: 'ocr', to: 'biometric', color: '#f87171', animated: true, label: 'Unclassified', labelPos: 0.3, curveOffset: 40 },
      { from: 'asr', to: 'biometric', color: '#f87171', animated: true, label: 'Unclassified', labelPos: 0.7, curveOffset: -40 },
  ...
  DSGAI10: {
    ...
    edges: [
      ...
      { from: 'synthetic', to: 'model', color: '#fbbf24', animated: true, label: 'Train', labelPos: 0.3, curveOffset: 40 },
      { from: 'synthetic', to: 'shared', color: '#fbbf24', animated: true, label: 'False safety', labelPos: 0.7, curveOffset: -40 },
      { from: 'model', to: 'attacker', color: '#f87171', animated: true, label: 'MI >0.9', labelPos: 0.3, curveOffset: 40 },
      { from: 'external', to: 'attacker', color: '#f87171', animated: true, label: 'Quasi-IDs', labelPos: 0.7, curveOffset: -40 },
  ...
  DSGAI11: {
    ...
    edges: [
      { from: 'tenantA', to: 'gateway', color: '#60a5fa', animated: true, label: 'Query', labelPos: 0.3, curveOffset: 40 },
      { from: 'tenantB', to: 'gateway', color: '#4ade80', animated: true, label: 'Query', labelPos: 0.7, curveOffset: -40 },
      { from: 'gateway', to: 'kvcache', color: '#f87171', animated: true, label: 'Shared cache', labelPos: 0.3, curveOffset: 55 },
      { from: 'gateway', to: 'vdb', color: '#a78bfa', animated: true, label: 'No namespace', labelPos: 0.5, curveOffset: 0 },
      { from: 'gateway', to: 'sessions', color: '#f87171', animated: true, label: 'Weak session', labelPos: 0.7, curveOffset: -55 },
      { from: 'vdb', to: 'llm', color: '#f87171', animated: true, label: 'Cross-tenant', labelPos: 0.7, curveOffset: -40 },
      { from: 'kvcache', to: 'llm', color: '#f87171', animated: true, label: 'Timing leak', labelPos: 0.3, curveOffset: 40 },
  ...
  DSGAI12: {
    ...
    edges: [
      { from: 'user', to: 'llm', color: '#60a5fa', animated: true, label: 'NL query', labelPos: 0.3, curveOffset: 40 },
      { from: 'inject', to: 'llm', color: '#f87171', animated: true, label: 'Inject via RAG', labelPos: 0.7, curveOffset: -40 },
      ...
      { from: 'sql', to: 'db1', color: '#f87171', animated: true, label: 'SELECT *', labelPos: 0.3, curveOffset: 45 },
      { from: 'sql', to: 'db2', color: '#f87171', animated: true, label: 'UNION JOIN', labelPos: 0.7, curveOffset: -45 },
      { from: 'db1', to: 'exfil', color: '#f87171', animated: true, label: 'Bulk dump', labelPos: 0.3, curveOffset: 40 },
      { from: 'db2', to: 'exfil', color: '#f87171', animated: true, label: 'Cross-tenant', labelPos: 0.7, curveOffset: -40 },
    ],
  ...
  DSGAI13: {
    ...
    edges: [
      { from: 'attacker', to: 'api', color: '#f87171', animated: true, label: 'No auth', labelPos: 0.3, curveOffset: 45 },
      { from: 'attacker', to: 'knn', color: '#f87171', animated: true, label: 'Systematic', labelPos: 0.7, curveOffset: -45 },
      ...
      { from: 'vdb', to: 'snapshot', color: '#2dd4bf', animated: true, label: 'Export', labelPos: 0.3, curveOffset: 45 },
      { from: 'snapshot', to: 'rce', color: '#f87171', animated: true, label: 'Path traversal' },
      { from: 'vdb', to: 'index', color: '#f87171', animated: true, label: 'Reconstruct', labelPos: 0.7, curveOffset: -45 },
  ...
  DSGAI14: {
    ...
    edges: [
      { from: 'llm', to: 'debug', color: '#f87171', animated: true, label: 'Full bodies', labelPos: 0.3, curveOffset: 55 },
      { from: 'llm', to: 'logpipe', color: '#a78bfa', animated: true, label: 'Prompts+resp', labelPos: 0.5, curveOffset: 0 },
      { from: 'llm', to: 'apm', color: '#60a5fa', animated: true, label: 'Tokens+traces', labelPos: 0.7, curveOffset: -55 },
  ...
  DSGAI15: {
    ...
    edges: [
      ...
      { from: 'provider', to: 'retained', color: '#f87171', animated: true, label: 'Logged', labelPos: 0.3, curveOffset: 40 },
      { from: 'provider', to: 'cache', color: '#f87171', animated: true, label: 'Cached', labelPos: 0.7, curveOffset: -40 },
    ],
  ...
  DSGAI16: {
    ...
    edges: [
      ...
      { from: 'perms', to: 'extension', color: '#f87171', animated: true, label: 'Broad perms', labelPos: 0.3, curveOffset: 55 },
      { from: 'browser', to: 'extension', color: '#facc15', animated: true, label: 'DOM + URL', labelPos: 0.5, curveOffset: 0 },
      { from: 'local', to: 'extension', color: '#f87171', animated: true, label: 'File access', labelPos: 0.3, curveOffset: 50 },
      { from: 'intranet', to: 'extension', color: '#f87171', animated: true, label: 'Scrape', labelPos: 0.7, curveOffset: -50 },
      { from: 'extension', to: 'exfil', color: '#f87171', animated: true, label: 'Exfil all' },
      { from: 'update', to: 'extension', color: '#f87171', animated: true, label: 'Supply chain', labelPos: 0.7, curveOffset: -55 },
    ],
  ...
  DSGAI17: {
    ...
    edges: [
      ...
      { from: 'fallback', to: 'primary', color: '#2dd4bf', animated: true, label: 'Try primary', labelPos: 0.3, curveOffset: 50 },
      ...
      { from: 'fallback', to: 'replica', color: '#f87171', animated: true, label: 'Silent switch', labelPos: 0.7, curveOffset: -50 },
  ...
  DSGAI18: {
    ...
    edges: [
      { from: 'attacker', to: 'probes', color: '#f87171', animated: true, label: 'Craft queries', labelPos: 0.3, curveOffset: 50 },
      { from: 'probes', to: 'llm', color: '#f87171', animated: true, label: 'Iterative' },
      { from: 'attacker', to: 'vdb', color: '#f87171', animated: true, label: 'k-NN sweep', labelPos: 0.7, curveOffset: -50 },
      ...
      { from: 'confidence', to: 'analysis', color: '#a78bfa', animated: true, label: 'Accumulate', labelPos: 0.3, curveOffset: 45 },
      { from: 'knn', to: 'analysis', color: '#a78bfa', animated: true, label: 'Inversion', labelPos: 0.7, curveOffset: -45 },
  ...
  DSGAI19: {
    ...
    edges: [
      ...
      { from: 'fullpii', to: 'platform', color: '#f87171', animated: true, label: 'PHI exposed', labelPos: 0.3, curveOffset: 40 },
      { from: 'creep', to: 'platform', color: '#f87171', animated: true, label: 'Fields added', labelPos: 0.7, curveOffset: -40 },
      { from: 'platform', to: 'labelerA', color: '#60a5fa', animated: true, label: 'Views PII', labelPos: 0.3, curveOffset: 45 },
      { from: 'platform', to: 'labelerB', color: '#f87171', animated: true, label: 'Views PII', labelPos: 0.7, curveOffset: -45 },
  ...
  DSGAI20: {
    ...
    edges: [
      { from: 'attacker', to: 'api', color: '#f87171', animated: true, label: 'Legit API', labelPos: 0.3, curveOffset: 40 },
      { from: 'accounts', to: 'api', color: '#f87171', animated: true, label: 'Distributed', labelPos: 0.7, curveOffset: -40 },
      { from: 'api', to: 'model', color: '#fb923c', animated: true, label: 'Queries', labelPos: 0.3, curveOffset: 40 },
      { from: 'cot', to: 'model', color: '#f87171', animated: true, label: 'Force CoT', labelPos: 0.7, curveOffset: -40 },
  ...
  DSGAI21: {
    ...
    edges: [
      { from: 'attacker', to: 'wiki', color: '#f87171', animated: true, label: 'Write access', labelPos: 0.3, curveOffset: 50 },
      { from: 'attacker', to: 'corpus', color: '#f87171', animated: true, label: 'Seed false', labelPos: 0.7, curveOffset: -50 },
      { from: 'crisis', to: 'attacker', color: '#f87171', animated: true, label: 'Crisis' },
      { from: 'wiki', to: 'trusted', color: '#f87171', animated: true, label: 'Indexed', labelPos: 0.3, curveOffset: 45 },
      { from: 'corpus', to: 'trusted', color: '#f87171', animated: true, label: 'Ingested', labelPos: 0.7, curveOffset: -45 },
      { from: 'trusted', to: 'rag', color: '#2dd4bf', animated: true, label: 'Retrieved' },
      { from: 'rag', to: 'grounded', color: '#f87171', animated: true, label: 'Cited', labelPos: 0.3, curveOffset: 45 },
      { from: 'rag', to: 'victim', color: '#f87171', animated: true, label: 'Misled', labelPos: 0.7, curveOffset: -45 },
    ],
...
function FlowEdge({ fromNode, toNode, color, animated, label, idx, diagramId, curveOffset }) {
  ...
  // Each edge curves by a different amount so labels don't stack
  const offset = curveOffset != null ? curveOffset : [40, -40, 60, -55, 35, -35, 50, -50][idx % 8]
